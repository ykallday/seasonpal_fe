...
export default function Search() {
    ...
    const {produce, seasonLocations} = useContext(UserContext)
...
return (
    <div className="bg-white">
        <div>
            <form className="text-center h-fit p-2 bg-white">
            ...
            <div className="p-3 text-center bg-lightblue w-[90vw] m-[auto] h-[80vh] rounded-lg my-5 overflow-scroll">
                ...
                <div className="grid grid-cols-3 p-8 rounded-lg w-[90vw] text-center">
